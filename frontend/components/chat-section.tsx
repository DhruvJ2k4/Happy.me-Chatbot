...
//   // Fetch latest emotion from the backend **before** sending message
...
//   // Start capturing frames when the user starts typing
...
//     // Fetch the latest emotion before sending the message
//     const latestEmotion = await getLatestEmotionFromBackend();

//     console.log("Emotion sent with message:", latestEmotion);
...
//       // Send user message + emotion to chatbot
...
export default function ChatSection({
  ...
  //   try {
  //     // Fetch the latest emotion from backend BEFORE sending message
  //     const latestEmotion = await getLatestEmotionFromBackend();
  //     console.log("Emotion sent with message:", latestEmotion);
  ...
  //     // Add user message to chat history with latest emotion
  //     const userMessage: ChatEntry = {
  //       user_input: inputValue,
  //       bot_response: "",
  //       emotion: latestEmotion,
  ...
  //     // Send user message + latest emotion to chatbot backend
  //     const response = await fetch("http://localhost:8000/chat/", {
  //       method: "POST",
  //       headers: { 
  //         "Content-Type": "application/json",
  ...
  //       body: JSON.stringify({
  //         message: inputValue,
  //         emotion: latestEmotion, // Ensure the latest emotion is always sent
  //       }),
  //     });
