...
//     for (let i = 0; i < 10; i++) {
//       await new Promise((resolve) => setTimeout(resolve, 250)); // Capture every 250ms
...
//             </Button>
//           ) : (
//             <Button variant="primary" size="sm" onClick={startWebcam} aria-label="Start webcam">
...
export default function WebcamSection({ triggerCapture }: { triggerCapture: boolean }) {
  ...
  //     localStorage.setItem("emotion", response.data.final_emotion); // Store emotion
  //   } catch (error) {
  //     console.error("Error sending frames:", error);
  //   }
  // };
