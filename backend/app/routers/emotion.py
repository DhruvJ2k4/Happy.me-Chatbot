...
#     print(f"File size: {len(image_bytes)} bytes")  # Debugging line
...
# #     """Process 10 uploaded images, detect emotions, and return the most frequent emotion."""
# #     if len(files) != 10:
# #         raise HTTPException(status_code=422, detail="Exactly 10 images are required.")
# #     try:
# #         frames = [read_image_as_numpy(file) for file in files]
